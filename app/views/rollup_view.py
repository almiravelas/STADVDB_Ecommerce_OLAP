...
def show_year_rollup(engine):
    ...
    df, duration, query, params = rollup_sales_by_year(engine)
...
def show_quarter_rollup(engine):
    ...
    df, duration, query, params = rollup_sales_by_quarter(engine)
...
def show_category_rollup(engine):
    ...
    df, duration, query, params = rollup_sales_by_category(engine)
...
def show_courier_rollup(engine):
    ...
    df, duration, query, params = rollup_sales_by_courier(engine)
